...
RUN if test $ref = "master" ; then apt-get install -y cm-super-minimal texlive-fonts-recommended texlive-latex-base texlive-latex-recommended ghostscript bsdmainutils ; fi
